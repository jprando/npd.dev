export default {
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: "Github", link: "https://github.com/jprando/npd.dev/" },
      { text: "Netlify", link: "https://app.netlify.com/sites/npd/overview" },
    ],
  },
};
